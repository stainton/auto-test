...
export async function main() {
  ...
  const generatorWorker=withExperience(createGeneratorWorker({command,runtime:generatorRuntime,playwrightPackage,assetCache,caseTimeoutMs:positive('GENERATOR_CASE_TIMEOUT_MS',600000)}),experience,productExperience);
