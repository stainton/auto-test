...
export async function main() {
  ...
  const claudeOptions = await resolveClaudeOptions({ prefix: 'GENERATOR',
  ...
  const jobs = new Jobs({
    ...
    worker: createGeneratorWorker({ command, ...claudeOptions, playwrightPackage,
      caseTimeoutMs: positive('GENERATOR_CASE_TIMEOUT_MS', 600000) }),
